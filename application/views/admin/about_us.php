...
<html lang="en">
   ...
   <body class="theme-orange">
               ...
               <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="body form-aj">
                            <form action="<?= base_url()?>Adminpanel/editAboutUs" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="min-box">
                                            ...
                                            <label>Image</label>
                                                ...
                                                <input type="hidden" name="id" value="<?=$aboutus_data->id?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <img src="<?=$aboutus_data->image_one?>" style="width:100px;height:100px">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="min-box">
                                            ...
                                            <label>Description</label>
                                                <textarea name="description_one" rows="3" class="form-control"><?php echo $aboutus_data->description_one; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <img src="<?=$aboutus_data->image_two?>" style="width:100px;height:100px">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="min-box">
                                            <div class="form-group">
                                            <label>Description</label>
                                                <textarea name="description_two" rows="3" class="form-control"><?php echo $aboutus_data->description_two; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <img src="<?=$aboutus_data->image_three?>" style="width:100px;height:100px">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="min-box">
                                            <div class="form-group">
                                            <label>Description</label>
                                                <textarea name="description_three" rows="3" class="form-control"><?php echo $aboutus_data->description_three; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <img src="<?=$aboutus_data->image_four?>" style="width:100px;height:100px">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="min-box">
                                            <div class="form-group">
                                            <label>Description</label>
                                                <textarea name="description_four" rows="3" class="form-control"><?php echo $aboutus_data->description_four; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
      ...
      <script type="text/javascript">
        ...
        CKEDITOR.replace('description_four',{
        });
    </script>
