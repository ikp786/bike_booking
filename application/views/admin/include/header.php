<nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="<?= base_url('dashboard')?>"><img src="<?= base_url()?>assets/user/img/logo.png" alt="Snaprides Logo" class="img-responsive logo"></a>                
            </div>
            ...
            <div class="navbar-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">                        
                        ...
                        <li><a href="<?= base_url()?>admin-login" class="icon-menu"><i class="icon-login"></i> Logout</a></li>                        
                    </ul>
                </div>
            </div>
        </div>
