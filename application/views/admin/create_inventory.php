               ...
               <div class="col-lg-12">
                  <div class="card">
                     ...
                     <div class="body form-aj">
                        <form action="<?= base_url()?>Adminpanel/crateInventory" method="post" enctype="multipart/form-data">
                              <div class="min-box-row">
                                 ...
                                 <div class="min-box">
                                    <div class="form-group">
                                       ...
                                       <input onkeypress="return validateNumber(event)" type="text" name="deposit_amount" class="form-control">
                                    </div>
                                 </div>
                                 <div class="min-box">
                                    <div class="form-group">
                                       <label>Price</label>
                                       <input onkeypress="return validateNumber(event)" type="text" name="price" class="form-control">
                                    </div>
                                 </div>
                                 <div class="min-box">
                                    <div class="form-group">
                                       <label>Access Price</label>
                                       <input onkeypress="return validateNumber(event)" type="text" name="access_price" class="form-control">
                                    </div>
                                 </div>
                                 <div class="min-box">
                                    <div class="form-group">
                                       <label>Damage Price</label>
                                       <input onkeypress="return validateNumber(event)" type="text" name="damage_price" class="form-control">
                                    </div>
                                 </div>
                                 <div class="min-box">
                                    <div class="form-group">
                                       <label>Final Price</label>
                                       <input onkeypress="return validateNumber(event)" type="text" name="final_price" class="form-control">
                                    </div>
                                 </div>
                                 <div class="min-box">
                                    <div class="form-group">
                                       <label>Access Hours/Days</label>
                                       <input onkeypress="return validateNumber(event)" type="text" name="access_hours" class="form-control">
                                    </div>
                                 </div>
                                 <div class="min-box">
                                    <div class="form-group">
